...
- Sixteen ammunition, magazine, shell, belt, and rocket sprites. Firearm metadata defines capacity, reserve-ammo transfer, reload duration, and the matching reload attachment.
...
Melee weapons use a relaxed one-handed carry below the chest, with their tips
kept clear of the ground. `attack_style` selects a swing, chop, or thrust. The
hand grips and torso movement share the same windup/contact/recovery timing;
longer weapons bring in the second hand during the strike. Recovery returns to
the resting pose. Firearms have stationary and moving recoil, a lower ready
hold, and reload tilt with the supporting hand following the magazine.
...
shows relaxed holds, all three melee styles, recoil, and reloads from four
